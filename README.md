...
3. **Google Maps** (через headless Selenium) — карточки бизнесов по городам Сербии.
4. **Краулер сайтов** — заходит на найденные домены, ищет страницы `/kontakt`,
   `/contact`, `/o-nama` и достаёт телефоны, e-mail, адреса и соцсети.
